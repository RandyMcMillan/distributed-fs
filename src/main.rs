    ...
    fn print_role_help(role: &str) {
        match role {
            "api" => {
                ...
                println!("  --logging LVL  Set log verbosity: off, warn, info, debug, or trace");
                println!();
